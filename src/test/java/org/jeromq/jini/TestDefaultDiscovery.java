...
public class TestDefaultDiscovery 
{
    static class App extends Thread 
    {
        ...
        App (String bind, String endpoints)
        {
            ...
            conf.setProperty ("heartbeat.endpoints", endpoints); // peers
    ...
    public void testDiscovery () throws Exception
    {
        ...
        App app2 = new App ("127.0.0.1:5556", "127.0.0.1:5555,127.0.0.1:5557");
